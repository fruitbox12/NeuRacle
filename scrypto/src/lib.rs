//! NeuRacle is a Layer 2 solution that provide 
//! decentralized, trustless data validation service 
...
//! 
//! The solution is using a Consensus Models, however, not
//! every Consensus solved the Blockchain trilemma. 
