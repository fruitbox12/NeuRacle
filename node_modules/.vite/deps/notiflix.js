...
var require_notiflix_aio_3_2_5_min = __commonJS({
  "node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js"(exports, module) {
    (function(t, e) {
      typeof define == "function" && define.amd ? define([], function() {
        return e(t);
      }) : typeof module == "object" && typeof module.exports == "object" ? module.exports = e(t) : t.Notiflix = e(t);
    })(typeof global == "undefined" ? typeof window == "undefined" ? exports : window : global, function(t) {
      "use strict";
      if (typeof t == "undefined" && typeof t.document == "undefined")
        return false;
      var e, i, a, n, o, r = "\n\nVisit documentation page to learn more: https://notiflix.github.io/documentation", s = '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif', l = { Success: "Success", Failure: "Failure", Warning: "Warning", Info: "Info" }, m = { wrapID: "NotiflixNotifyWrap", overlayID: "NotiflixNotifyOverlay", width: "280px", position: "right-top", distance: "10px", opacity: 1, borderRadius: "5px", rtl: false, timeout: 3e3, messageMaxLength: 110, backOverlay: false, backOverlayColor: "rgba(0,0,0,0.5)", plainText: true, showOnlyTheLastOne: false, clickToClose: false, pauseOnHover: true, ID: "NotiflixNotify", className: "notiflix-notify", zindex: 4001, fontFamily: "Quicksand", fontSize: "13px", cssAnimation: true, cssAnimationDuration: 400, cssAnimationStyle: "fade", closeButton: false, useIcon: true, useFontAwesome: false, fontAwesomeIconStyle: "basic", fontAwesomeIconSize: "34px", success: { background: "#32c682", textColor: "#fff", childClassName: "notiflix-notify-success", notiflixIconColor: "rgba(0,0,0,0.2)", fontAwesomeClassName: "fas fa-check-circle", fontAwesomeIconColor: "rgba(0,0,0,0.2)", backOverlayColor: "rgba(50,198,130,0.2)" }, failure: { background: "#ff5549", textColor: "#fff", childClassName: "notiflix-notify-failure", notiflixIconColor: "rgba(0,0,0,0.2)", fontAwesomeClassName: "fas fa-times-circle", fontAwesomeIconColor: "rgba(0,0,0,0.2)", backOverlayColor: "rgba(255,85,73,0.2)" }, warning: { background: "#eebf31", textColor: "#fff", childClassName: "notiflix-notify-warning", notiflixIconColor: "rgba(0,0,0,0.2)", fontAwesomeClassName: "fas fa-exclamation-circle", fontAwesomeIconColor: "rgba(0,0,0,0.2)", backOverlayColor: "rgba(238,191,49,0.2)" }, info: { background: "#26c0d3", textColor: "#fff", childClassName: "notiflix-notify-info", notiflixIconColor: "rgba(0,0,0,0.2)", fontAwesomeClassName: "fas fa-info-circle", fontAwesomeIconColor: "rgba(0,0,0,0.2)", backOverlayColor: "rgba(38,192,211,0.2)" } }, c = { Success: "Success", Failure: "Failure", Warning: "Warning", Info: "Info" }, p = { ID: "NotiflixReportWrap", className: "notiflix-report", width: "320px", backgroundColor: "#f8f8f8", borderRadius: "25px", rtl: false, zindex: 4002, backOverlay: true, backOverlayColor: "rgba(0,0,0,0.5)", backOverlayClickToClose: false, fontFamily: "Quicksand", svgSize: "110px", plainText: true, titleFontSize: "16px", titleMaxLength: 34, messageFontSize: "13px", messageMaxLength: 400, buttonFontSize: "14px", buttonMaxLength: 34, cssAnimation: true, cssAnimationDuration: 360, cssAnimationStyle: "fade", success: { svgColor: "#32c682", titleColor: "#1e1e1e", messageColor: "#242424", buttonBackground: "#32c682", buttonColor: "#fff", backOverlayColor: "rgba(50,198,130,0.2)" }, failure: { svgColor: "#ff5549", titleColor: "#1e1e1e", messageColor: "#242424", buttonBackground: "#ff5549", buttonColor: "#fff", backOverlayColor: "rgba(255,85,73,0.2)" }, warning: { svgColor: "#eebf31", titleColor: "#1e1e1e", messageColor: "#242424", buttonBackground: "#eebf31", buttonColor: "#fff", backOverlayColor: "rgba(238,191,49,0.2)" }, info: { svgColor: "#26c0d3", titleColor: "#1e1e1e", messageColor: "#242424", buttonBackground: "#26c0d3", buttonColor: "#fff", backOverlayColor: "rgba(38,192,211,0.2)" } }, f = { Show: "Show", Ask: "Ask", Prompt: "Prompt" }, d = { ID: "NotiflixConfirmWrap", className: "notiflix-confirm", width: "300px", zindex: 4003, position: "center", distance: "10px", backgroundColor: "#f8f8f8", borderRadius: "25px", backOverlay: true, backOverlayColor: "rgba(0,0,0,0.5)", rtl: false, fontFamily: "Quicksand", cssAnimation: true, cssAnimationDuration: 300, cssAnimationStyle: "fade", plainText: true, titleColor: "#32c682", titleFontSize: "16px", titleMaxLength: 34, messageColor: "#1e1e1e", messageFontSize: "14px", messageMaxLength: 110, buttonsFontSize: "15px", buttonsMaxLength: 34, okButtonColor: "#f8f8f8", okButtonBackground: "#32c682", cancelButtonColor: "#f8f8f8", cancelButtonBackground: "#a9a9a9" }, x = { Standard: "Standard", Hourglass: "Hourglass", Circle: "Circle", Arrows: "Arrows", Dots: "Dots", Pulse: "Pulse", Custom: "Custom", Notiflix: "Notiflix" }, g = { ID: "NotiflixLoadingWrap", className: "notiflix-loading", zindex: 4e3, backgroundColor: "rgba(0,0,0,0.8)", rtl: false, fontFamily: "Quicksand", cssAnimation: true, cssAnimationDuration: 400, clickToClose: false, customSvgUrl: null, customSvgCode: null, svgSize: "80px", svgColor: "#32c682", messageID: "NotiflixLoadingMessage", messageFontSize: "15px", messageMaxLength: 34, messageColor: "#dcdcdc" }, b = { Standard: "Standard", Hourglass: "Hourglass", Circle: "Circle", Arrows: "Arrows", Dots: "Dots", Pulse: "Pulse" }, u = { ID: "NotiflixBlockWrap", querySelectorLimit: 200, className: "notiflix-block", position: "absolute", zindex: 1e3, backgroundColor: "rgba(255,255,255,0.9)", rtl: false, fontFamily: "Quicksand", cssAnimation: true, cssAnimationDuration: 300, svgSize: "45px", svgColor: "#383838", messageFontSize: "14px", messageMaxLength: 34, messageColor: "#383838" }, y = function(t2) {
        ...
        return e2 || (e2 = "head"), t.document[e2] !== null || (y('\nNotiflix needs to be appended to the "<' + e2 + '>" element, but you called it before the "<' + e2 + '>" element has been created.'), false);
      }, h = function(e2, i2) {
        if (!w("head"))
          return false;
        if (e2() !== null && !t.document.getElementById(i2)) {
          var a2 = t.document.createElement("style");
          a2.id = i2, a2.innerHTML = e2(), t.document.head.appendChild(a2);
        }
      }, v = function() {
        var t2 = {}, e2 = false, a2 = 0;
        Object.prototype.toString.call(arguments[0]) === "[object Boolean]" && (e2 = arguments[0], a2++);
        for (var n2 = function(i2) {
          for (var a3 in i2)
            Object.prototype.hasOwnProperty.call(i2, a3) && (t2[a3] = e2 && Object.prototype.toString.call(i2[a3]) === "[object Object]" ? v(t2[a3], i2[a3]) : i2[a3]);
        }; a2 < arguments.length; a2++)
          n2(arguments[a2]);
        return t2;
      }, N = function(e2) {
        ...
        e || G.Notify.init({});
        var c2 = v(true, e, {});
        if (typeof o2 == "object" && !Array.isArray(o2) || typeof r2 == "object" && !Array.isArray(r2)) {
          var p2 = {};
          typeof o2 == "object" ? p2 = o2 : typeof r2 == "object" && (p2 = r2), e = v(true, e, p2);
        }
        var f2 = e[a2.toLocaleLowerCase("en")];
        T++, typeof n2 != "string" && (n2 = "Notiflix " + a2), e.plainText && (n2 = N(n2)), !e.plainText && n2.length > e.messageMaxLength && (e = v(true, e, { closeButton: true, messageMaxLength: 150 }), n2 = 'Possible HTML Tags Error: The "plainText" option is "false" and the notification content length is more than the "messageMaxLength" option.'), n2.length > e.messageMaxLength && (n2 = n2.substring(0, e.messageMaxLength) + "..."), e.fontAwesomeIconStyle === "shadow" && (f2.fontAwesomeIconColor = f2.background), e.cssAnimation || (e.cssAnimationDuration = 0);
        var d2 = t.document.getElementById(m.wrapID) || t.document.createElement("div");
        if (d2.id = m.wrapID, d2.style.width = e.width, d2.style.zIndex = e.zindex, d2.style.opacity = e.opacity, e.position === "center-center" ? (d2.style.left = e.distance, d2.style.top = e.distance, d2.style.right = e.distance, d2.style.bottom = e.distance, d2.style.margin = "auto", d2.classList.add("nx-flex-center-center"), d2.style.maxHeight = "calc((100vh - " + e.distance + ") - " + e.distance + ")", d2.style.display = "flex", d2.style.flexWrap = "wrap", d2.style.flexDirection = "column", d2.style.justifyContent = "center", d2.style.alignItems = "center", d2.style.pointerEvents = "none") : e.position === "center-top" ? (d2.style.left = e.distance, d2.style.right = e.distance, d2.style.top = e.distance, d2.style.bottom = "auto", d2.style.margin = "auto") : e.position === "center-bottom" ? (d2.style.left = e.distance, d2.style.right = e.distance, d2.style.bottom = e.distance, d2.style.top = "auto", d2.style.margin = "auto") : e.position === "right-bottom" ? (d2.style.right = e.distance, d2.style.bottom = e.distance, d2.style.top = "auto", d2.style.left = "auto") : e.position === "left-top" ? (d2.style.left = e.distance, d2.style.top = e.distance, d2.style.right = "auto", d2.style.bottom = "auto") : e.position === "left-bottom" ? (d2.style.left = e.distance, d2.style.bottom = e.distance, d2.style.top = "auto", d2.style.right = "auto") : (d2.style.right = e.distance, d2.style.top = e.distance, d2.style.left = "auto", d2.style.bottom = "auto"), e.backOverlay) {
        ...
        g2.id = e.ID + "-" + T, g2.className = e.className + " " + f2.childClassName + " " + (e.cssAnimation ? "nx-with-animation" : "") + " " + (e.useIcon ? "nx-with-icon" : "") + " nx-" + e.cssAnimationStyle + " " + (e.closeButton && typeof o2 != "function" ? "nx-with-close-button" : "") + " " + (typeof o2 == "function" ? "nx-with-callback" : "") + " " + (e.clickToClose ? "nx-notify-click-to-close" : ""), g2.style.fontSize = e.fontSize, g2.style.color = f2.textColor, g2.style.background = f2.background, g2.style.borderRadius = e.borderRadius, g2.style.pointerEvents = "all", e.rtl && (g2.setAttribute("dir", "rtl"), g2.classList.add("nx-rtl-on")), g2.style.fontFamily = '"' + e.fontFamily + '", ' + s, e.cssAnimation && (g2.style.animationDuration = e.cssAnimationDuration + "ms");
        var b2 = "";
        if (e.closeButton && typeof o2 != "function" && (b2 = '<span class="nx-close-button"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><g><path fill="' + f2.notiflixIconColor + '" d="M0.38 2.19l7.8 7.81 -7.8 7.81c-0.51,0.5 -0.51,1.31 -0.01,1.81 0.25,0.25 0.57,0.38 0.91,0.38 0.34,0 0.67,-0.14 0.91,-0.38l7.81 -7.81 7.81 7.81c0.24,0.24 0.57,0.38 0.91,0.38 0.34,0 0.66,-0.14 0.9,-0.38 0.51,-0.5 0.51,-1.31 0,-1.81l-7.81 -7.81 7.81 -7.81c0.51,-0.5 0.51,-1.31 0,-1.82 -0.5,-0.5 -1.31,-0.5 -1.81,0l-7.81 7.81 -7.81 -7.81c-0.5,-0.5 -1.31,-0.5 -1.81,0 -0.51,0.51 -0.51,1.32 0,1.82z"/></g></svg></span>'), !e.useIcon)
          g2.innerHTML = '<span class="nx-message">' + n2 + "</span>" + (e.closeButton ? b2 : "");
        else if (e.useFontAwesome)
          g2.innerHTML = '<i style="color:' + f2.fontAwesomeIconColor + "; font-size:" + e.fontAwesomeIconSize + ';" class="nx-message-icon nx-message-icon-fa ' + f2.fontAwesomeClassName + " " + (e.fontAwesomeIconStyle === "shadow" ? "nx-message-icon-fa-shadow" : "nx-message-icon-fa-basic") + '"></i><span class="nx-message nx-with-icon">' + n2 + "</span>" + (e.closeButton ? b2 : "");
        else {
          var u2 = "";
        ...
        if (e.position === "left-bottom" || e.position === "right-bottom") {
        ...
        if (k2) {
          var h2, C2, z2 = function() {
            ...
            if (k2 && k2.parentNode !== null && k2.parentNode.removeChild(k2), 0 >= d2.childElementCount && d2.parentNode !== null) {
              d2.parentNode.removeChild(d2);
              var e2 = t.document.getElementById(m.overlayID);
              e2 && e2.parentNode !== null && e2.parentNode.removeChild(e2);
            }
            clearTimeout(C2);
          };
          if (e.closeButton && typeof o2 != "function") {
          ...
          if ((typeof o2 == "function" || e.clickToClose) && k2.addEventListener("click", function() {
            typeof o2 == "function" && o2(), z2();
            var t2 = setTimeout(function() {
              S2(), clearTimeout(t2);
            }, e.cssAnimationDuration);
          }), !e.closeButton && typeof o2 != "function") {
            var W2 = function() {
        ...
        if (e.showOnlyTheLastOne && 0 < T)
          for (var I2, R2 = t.document.querySelectorAll("[id^=" + e.ID + "-]:not([id=" + e.ID + "-" + T + "])"), A2 = 0; A2 < R2.length; A2++)
            I2 = R2[A2], I2.parentNode !== null && I2.parentNode.removeChild(I2);
        e = v(true, e, c2);
      }, E = function() {
        ...
        var g2 = "", b2 = i.backOverlayClickToClose === true;
        ...
        var b2 = typeof a.position == "string" ? a.position.trim() : "center";
        ...
        var y2 = "";
        typeof m2 == "function" && (y2 = '<a id="NXConfirmButtonCancel" class="nx-confirm-button-cancel" style="color:' + a.cancelButtonColor + ";background:" + a.cancelButtonBackground + ";font-size:" + a.buttonsFontSize + ';">' + l2 + "</a>");
        ...
        if (g2.innerHTML = u2 + '<div class="' + a.className + '-content" style="width:' + a.width + "; background:" + a.backgroundColor + "; animation-duration:" + a.cssAnimationDuration + "ms; border-radius: " + a.borderRadius + ';"><div class="' + a.className + '-head"><h5 style="color:' + a.titleColor + ";font-size:" + a.titleFontSize + ';">' + i2 + '</h5><div style="color:' + a.messageColor + ";font-size:" + a.messageFontSize + ';">' + n2 + k2 + '</div></div><div class="' + a.className + '-buttons"><a id="NXConfirmButtonOk" class="nx-confirm-button-ok' + (typeof m2 == "function" ? "" : " nx-full") + '" style="color:' + a.okButtonColor + ";background:" + a.okButtonBackground + ";font-size:" + a.buttonsFontSize + ';">' + r2 + "</a>" + y2 + "</div></div>", !t.document.getElementById(g2.id)) {
          ...
          if (I2 && (I2.focus(), I2.setSelectionRange(0, (I2.value || "").length), I2.addEventListener("keyup", function(t2) {
            ...
            if (e2 === f.Ask && i3 !== h2)
              ...
              var a2 = (t2.key || "").toLocaleLowerCase("en") === "enter" || t2.keyCode === 13;
            ...
            typeof m2 == "function" && (e2 === f.Prompt && I2 && (C2 = I2.value || ""), m2(C2)), L2.classList.add("nx-remove");
            var n3 = setTimeout(function() {
              L2.parentNode !== null && (L2.parentNode.removeChild(L2), clearTimeout(n3));
            }, a.cssAnimationDuration);
          }), typeof m2 == "function") {
            var R2 = t.document.getElementById("NXConfirmButtonCancel");
            R2.addEventListener("click", function() {
              typeof c2 == "function" && (e2 === f.Prompt && I2 && (C2 = I2.value || ""), c2(C2)), L2.classList.add("nx-remove");
              var t2 = setTimeout(function() {
                L2.parentNode !== null && (L2.parentNode.removeChild(L2), clearTimeout(t2));
              }, a.cssAnimationDuration);
            });
          }
        }
        ...
        n || G.Loading.init({});
        var l2 = v(true, n, {});
        if (typeof i2 == "object" && !Array.isArray(i2) || typeof a2 == "object" && !Array.isArray(a2)) {
          var m2 = {};
          typeof i2 == "object" ? m2 = i2 : typeof a2 == "object" && (m2 = a2), n = v(true, n, m2);
        }
        var c2 = "";
        if (typeof i2 == "string" && 0 < i2.length && (c2 = i2), o2) {
          ...
          var f2 = "";
          if (e2 === x.Standard)
            f2 = W(n.svgSize, n.svgColor);
          else if (e2 === x.Hourglass)
            f2 = I(n.svgSize, n.svgColor);
          else if (e2 === x.Circle)
            f2 = R(n.svgSize, n.svgColor);
          else if (e2 === x.Arrows)
            f2 = A(n.svgSize, n.svgColor);
          else if (e2 === x.Dots)
            f2 = M(n.svgSize, n.svgColor);
          else if (e2 === x.Pulse)
            f2 = B(n.svgSize, n.svgColor);
          else if (e2 === x.Custom && n.customSvgCode !== null && n.customSvgUrl === null)
            f2 = n.customSvgCode || "";
          else if (e2 === x.Custom && n.customSvgUrl !== null && n.customSvgCode === null)
            f2 = '<img class="nx-custom-loading-icon" width="' + n.svgSize + '" height="' + n.svgSize + '" src="' + n.customSvgUrl + '" alt="Notiflix">';
          else {
            if (e2 === x.Custom && (n.customSvgUrl === null || n.customSvgCode === null))
          ...
          if (h2.id = g.ID, h2.className = n.className + (n.cssAnimation ? " nx-with-animation" : "") + (n.clickToClose ? " nx-loading-click-to-close" : ""), h2.style.zIndex = n.zindex, h2.style.background = n.backgroundColor, h2.style.animationDuration = n.cssAnimationDuration + "ms", h2.style.fontFamily = '"' + n.fontFamily + '", ' + s, h2.style.display = "flex", h2.style.flexWrap = "wrap", h2.style.flexDirection = "column", h2.style.alignItems = "center", h2.style.justifyContent = "center", n.rtl && (h2.setAttribute("dir", "rtl"), h2.classList.add("nx-rtl-on")), h2.innerHTML = k2 + p2, !t.document.getElementById(h2.id) && (t.document.body.appendChild(h2), n.clickToClose)) {
            ...
            C2.addEventListener("click", function() {
              ...
              var t2 = setTimeout(function() {
                h2.parentNode !== null && (h2.parentNode.removeChild(h2), clearTimeout(t2));
          ...
          var z2 = t.document.getElementById(g.ID), S2 = setTimeout(function() {
            ...
            var t2 = setTimeout(function() {
              z2.parentNode !== null && (z2.parentNode.removeChild(z2), clearTimeout(t2));
            }, n.cssAnimationDuration);
            clearTimeout(S2);
          }, r2);
        n = v(true, n, l2);
        ...
        if (Array.isArray(a2)) {
          ...
          var c2 = typeof a2 != "string" || 1 > (a2 || "").length || (a2 || "").length === 1 && ((a2 || "")[0] === "#" || (a2 || "")[0] === ".");
          if (c2)
          ...
          if (1 > p2.length)
            return y('You called the "Notiflix.Block..." function with "' + a2 + '" selector, but there is no such element(s) in the document.'), false;
          m2 = p2;
        }
        o || G.Block.init({});
        var f2 = v(true, o, {});
        if (typeof n2 == "object" && !Array.isArray(n2) || typeof r2 == "object" && !Array.isArray(r2)) {
          var d2 = {};
          typeof n2 == "object" ? d2 = n2 : typeof r2 == "object" && (d2 = r2), o = v(true, o, d2);
        }
        var x2 = "";
        typeof n2 == "string" && 0 < n2.length && (x2 = n2), o.cssAnimation || (o.cssAnimationDuration = 0);
        var g2 = u.className;
        typeof o.className == "string" && (g2 = o.className.trim());
        var h2 = typeof o.querySelectorLimit == "number" ? o.querySelectorLimit : 200, C2 = (m2 || []).length >= h2 ? h2 : m2.length, z2 = "nx-block-temporary-position";
        if (e2) {
          for (var S2, L2 = ["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr", "html", "head", "title", "script", "style", "iframe"], X2 = 0; X2 < C2; X2++)
            if (S2 = m2[X2], S2) {
              ...
              if (1 > D2.length) {
                ...
                var O2 = t.getComputedStyle(S2).getPropertyValue("position"), H2 = typeof O2 == "string" ? O2.toLocaleLowerCase("en") : "relative", P2 = Math.round(1.25 * parseInt(o.svgSize)) + 40, U2 = S2.offsetHeight || 0, V2 = "";
          ...
          var _ = function(e3) {
            var i3 = setTimeout(function() {
              e3.parentNode !== null && e3.parentNode.removeChild(e3);
              var a3 = e3.getAttribute("id"), n3 = t.document.getElementById("Style-" + a3);
              n3 && n3.parentNode !== null && n3.parentNode.removeChild(n3), clearTimeout(i3);
            }, o.cssAnimationDuration);
          }, tt = function(t2) {
            if (t2 && 0 < t2.length)
              for (var e3, n3 = 0; n3 < t2.length; n3++)
                e3 = t2[n3], e3 && (e3.classList.add("nx-remove"), _(e3));
            else
              typeof a2 == "string" ? k('"Notiflix.Block.remove();" function called with "' + a2 + '" selector, but this selector does not have a "Block" element to remove.') : k('"Notiflix.Block.remove();" function called with "' + a2 + '", but this "Array<HTMLElement>" or "NodeListOf<HTMLElement>" does not have a "Block" element to remove.');
          }, et = function(t2) {
            var e3 = setTimeout(function() {
              t2.classList.remove(z2), clearTimeout(e3);
            }, o.cssAnimationDuration + 300);
          }, it = setTimeout(function() {
            for (var t2, e3 = 0; e3 < C2; e3++)
              t2 = m2[e3], t2 && (et(t2), D2 = t2.querySelectorAll("[id^=" + u.ID + "]"), tt(D2));
            clearTimeout(it);
          }, l2);
        o = v(true, o, f2);
        ...
        typeof t2 != "number" && (t2 = 0), U(null, null, null, false, t2);
      }, change: function(t2) {
        V(t2);
        ...
        typeof e2 != "number" && (e2 = 0), Y(false, null, t2, null, null, e2);
      } } };
      return typeof t.Notiflix == "object" ? v(true, t.Notiflix, { Notify: G.Notify, Report: G.Report, Confirm: G.Confirm, Loading: G.Loading, Block: G.Block }) : { Notify: G.Notify, Report: G.Report, Confirm: G.Confirm, Loading: G.Loading, Block: G.Block };
    });
  }
});

// dep:notiflix
var notiflix_default = require_notiflix_aio_3_2_5_min();
export {
  notiflix_default as default
};
